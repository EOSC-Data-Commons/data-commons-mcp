...
from data_commons_mcp.mcp_server import get_relevant_tools
from data_commons_mcp.models import OpenSearchResults, RankedSearchResponse
...
async def test_get_relevant_tools() -> None:
    ...
    await get_relevant_tools(OpenSearchResults(total_found=len(dummy_search_res.hits), hits=dummy_search_res.hits))
    # print(docs)
