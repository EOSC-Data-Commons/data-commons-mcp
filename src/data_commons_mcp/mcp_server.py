...
@mcp.tool()
async def search_data(question: str, start_date: str | None = None, end_date: str | None = None) -> OpenSearchResults:
    """Search for data relevant to the user question using OpenSearch and vector KNN.
    ...
    embedding = next(iter(embedding_model.embed([question])))

    # Define filters
    filters = [
        # NOTE: latest indexing does not seems to include resourceTypeGeneral field
        # {
        #     "nested": {
        #         "path": "types",
